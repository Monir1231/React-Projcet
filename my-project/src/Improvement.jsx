  ...
  return (
    <>
        <section className='px-4 md:px-6 lg:px-12 xl:px-24 py-20 md:py-24 lg:py-20 bg-[#002228]'>
          ...
          <h2 className="italic text-[#0FF1F6] text-[28px] md:text-[32px] lg:text-[32px] font-bold mb-3"> prefered email st|</h2>
          ...
          <div className='flex flex-col sm:flex-col md:flex-row md:items-center gap-12 md:gap-6 mt-7 md:mt-10 lg:mt-16 xl:mt-20'>
            ...
            <div key={index} className=''>
                <h2 className='text-[#0FF1F6] text-[32px] md:text-[36px] lg:text-[40px] font-bold mb-4' >{item.per}</h2>
              
                 <p className='text-[#E9EEF1] text-lg lg:text-[20px] lg:max-w-[190px] '>{item.des}</p>

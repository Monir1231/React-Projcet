...
function Hero() {
  return (
    <>
      <section className="bg-black lg:py-6 max-w-[1440px] mx-auto bg-[url(image2.png)] bg-no-repeat bg-center bg-cover">
        <div className=" px-2.5 lg:px-10 xl:px-20 text-white py-12 lg:py-20 text-center md:text-left">
          ...
          <p className="lg:max-w-md text-[18px] lg:text-[20px] py-2 text-[#f1f1f1]">
          ...
          <Button
            variant="solid"
            className="text-black bg-[#0FF1F6] mt-3 lg:mt-2 w-full md:w-fit rounded-full py-3"
          >
